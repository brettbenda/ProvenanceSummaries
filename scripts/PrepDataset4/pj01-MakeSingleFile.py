...
def merge_JsonFiles(dir, filename):
    ...
    for f1 in filename:
        with open(dir+f1, 'r') as infile:
            ...
            #TODO: Consider replacing all the "spk_0" with the first linked speaker so it shows up often.
            content["contents"] = content.pop("transcriptBySpeaker")
            result.append(content)

    with open(dir + '../../Dataset_4/Documents/dataset4.json', 'w') as output_file:
